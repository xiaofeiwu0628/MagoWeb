...
const messages = {
  en: {
    ...
    material_btn_music: "Play Music",
    material_btn_expression: "Change Expression",
    material_btn_load: "Load Action Group",
    material_btn_save: "Save Action Group",
    ui_title: "UI",
  ...
  "zh-Hans": {
    ...
    material_btn_music: "播放音乐",
    material_btn_expression: "变换表情",
    material_btn_load: "加载动作组",
    material_btn_save: "保存动作组",
    ui_title: "界面",
  ...
  "zh-Hant": {
    ...
    material_btn_music: "播放音樂",
    material_btn_expression: "變換表情",
    material_btn_load: "載入動作組",
    material_btn_save: "保存動作組",
    ui_title: "介面",
